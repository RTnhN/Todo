class Database {
  ...
  deleteTask(taskId) {
    this.projects
      .find((project) => project.tasks.find((task) => task.id === taskId))
  ...
  updateTask(taskUpdated) {
    this.projects
      .find((project) => project.tasks.find((task) => task.id === taskUpdated.id))
      .updateTask(taskUpdated);
    this.writeStorage();
  }
  ...
  getTaskByID(id) {
    return this.projects
      .find((project) => project.tasks.find((task) => task.id === id))
