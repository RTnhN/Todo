...
class TaskInfoModalDOMManager {
  ...
  constructor(taskInfoModalElement) {
    ...
    this.make();
    document
      .getElementById('taskInfoModalCloseButton')
      .addEventListener('click', this.#taskInfoModalElement.close());
    document
      .getElementById('taskInfoModalStartDate')
      .addEventListener('change', this.startDateChange.bind(this));
    document
      .getElementById('taskInfoModalEndDate')
  ...
  startDateChange(event) {
    const endDate = this.#taskInfoModalElement.getElementById('taskInfoModalEndDate');
    if (
      endDate.value !== ''
  ...
  endDateChange(event) {
    const startDate = this.#taskInfoModalElement.getElementById('taskInfoModalStartDate');
    if (
      startDate.value !== ''
  ...
  updateTargetTask(task) {
    ...
    document.getElementById('taskInfoModalStartDate').value = task.startDate === ''
      ? ''
      : format(task.startDate, "yyyy-MM-dd'T'kk:mm");
    document.getElementById('taskInfoModalEndDate').value = task.endDate === ''
      ? ''
      : format(task.endDate, "yyyy-MM-dd'T'kk:mm");
  ...
  get acceptButton() {
    return this.#taskInfoModalElement.getElementById('taskInfoModalAcceptButton');
  }

  get cancelButton() {
    return this.#taskInfoModalElement.getElementById('taskInfoModalCancelButton');
  }

  get deleteButton() {
    return this.#taskInfoModalElement.getElementById('taskInfoModalDeleteButton');
  }

  get form() {
    return this.#taskInfoModalElement.getElementById('taskInfoModalForm');
  }
