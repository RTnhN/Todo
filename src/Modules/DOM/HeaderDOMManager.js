class HeaderDOMManager {
  ...
  toggleProjectMenu() {
    ...
    this.menuButton.textContent = headerButton === 'chevron_right'
      ? 'chevron_left'
      : 'chevron_right';
    const gridWidth = this.#headerElement.parentElement.style.gridTemplateColumns;
    this.#headerElement.parentElement.style.gridTemplateColumns = gridWidth === ''
      ? '400px 1fr'
      : '';
  }

  get menuButton() {
    return this.#headerElement.getElementById('projectMenuButton');
  }
}
