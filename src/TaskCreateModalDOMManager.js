...
class TaskCreateModalDOMManager {
  ...
  constructor(taskCreateModalElement) {
    ...
    this.make();
    document.getElementById("taskCreateModalCancel").addEventListener("click", this.#taskCreateModalElement.close());
    document.getElementById("taskCreateModalStartDate").addEventListener("change", this.startDateChange.bind(this));
    document.getElementById("taskCreateModalEndDate").addEventListener("change", this.endDateChange.bind(this));
    this.mode = "make";
  ...
  startDateChange(event){
    const endDate = document.getElementById("taskCreateModalEndDate");
  ...
  endDateChange(event){
    const startDate = document.getElementById("taskCreateModalStartDate");
  ...
  get acceptButton() {
    return document.getElementById("taskCreateModalSubmit");
  }
  get cancelButton() {
    return document.getElementById("taskCreateModalCancel");
  }
  get form(){
    return document.getElementById("taskCreateModalForm");
  }
}
