...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Task_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Task.js */ \"./src/Task.js\");\n/* harmony import */ var _Database_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Database.js */ \"./src/Database.js\");\n/* harmony import */ var _LocalStorageAgent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LocalStorageAgent.js */ \"./src/LocalStorageAgent.js\");\n/* harmony import */ var _HeaderManager_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./HeaderManager.js */ \"./src/HeaderManager.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\n\n\nconst contentElement = document.getElementById(\"content\");\ncontentElement.appendChild(document.createElement(\"header\"));\ncontentElement.lastChild.id = \"header\";\ncontentElement.appendChild(document.createElement(\"div\"));\ncontentElement.lastChild.id = \"main\";\ncontentElement.appendChild(document.createElement(\"footer\"));\ncontentElement.lastChild.id = \"footer\";\n\nconst headerManager = new _HeaderManager_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](contentElement);\nconst localStorageAgent = new _LocalStorageAgent_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](_Task_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nconst database = new _Database_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](localStorageAgent);\n\nheaderManager.makeHeader()\nconst form = document.getElementById(\"newTaskForm\");\nform.onsubmit = addTask\n// headerManager.makeList(database.tasks);\nlocalStorageAgent.clear();\n\n// document.querySelectorAll(\".taskName button\").forEach(element=> element.addEventListener(\"click\", deleteTask))\n\nfunction deleteTask(e){\n  const deleteID = e.target.parentElement.parentElement.id;\n  database.deleteTask(deleteID);\n  // DOMmanager.makeList(database.tasks);\n  // document.querySelectorAll(\".taskName button\").forEach(element=> element.addEventListener(\"click\", deleteTask))\n\n\n}\n\nfunction addTask(e){\n  e.preventDefault();\n  const formData = new FormData(form);\n  if (formData.get(\"name\") === null || formData.get(\"name\") === \"\") return\n  database.addTask(new _Task_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](Object.fromEntries(formData)));\n  // DOMmanager.makeList(database.tasks);\n  // document.querySelectorAll(\".taskName button\").forEach(element=> element.addEventListener(\"click\", deleteTask))\n  form.reset();\n\n}\n\n\n\n\n//# sourceURL=webpack://todo/./src/index.js?");
